...
import { runWorkflow,getExecution,getExecutionJobs} from "../controllers/runWorkflow.controller.js";
import {
  getWorkflows,
  getWorkflow,
} from "../controllers/workflow.controller.js";

import {getWorkflowDependencies} from "../controllers/workflowDependency.controller.js";
...
router.get("/:workflowId/dependencies", getWorkflowDependencies);
router.get("/:workflowId/executions", getExecution);
router.get("/:workflowExecutionId/execution/jobs", getExecutionJobs);
